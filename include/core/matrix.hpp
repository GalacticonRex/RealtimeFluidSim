...
struct matrix
{
	...
	static matrix<row,col> identity() {
		if ( row != col ) {
			throw "Cannot set non-square matrix to identity";
		}
...
mat3 translate3 ( vec2 );
mat4 translate4 ( vec3 );
mat3 scale3 ( vec2 );
mat4 scale4 ( vec3 );

mat3 ortho3 ( vec2, vec2 );
mat3 ortho3 ( vec2 );
mat4 ortho4 ( vec2, vec2 );
mat4 ortho4 ( vec2 );
mat4 perspect ( float32, float32, float32, float32 );
